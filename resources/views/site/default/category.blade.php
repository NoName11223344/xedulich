            ...
            <div class="row">
                <div class="large-12 text-center col">
                    <h1 class="page-title is-large uppercase">
                        Category Archives: <span>{{ $category->title }}</span></h1>
                </div>
            </div>
        </header>
                ...
                <div id="row-1056452350{{ rand(1,100) }}"
                    ...
                    @foreach ($posts as $id => $post)
                            <div class="col post-item">
                                <div class="col-inner">
                                    <a href="{{ route('post', ['cate_slug' => $category->slug, 'post_slug' => $post->slug, 'languageCurrent' => $languageCurrent]) }}" class="plain">
